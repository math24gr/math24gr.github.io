...
\begin{textblock}{17}(-1,28)
 \color{backsite} \begin{small}Copyright \textcopyright 2017, Κασωτάκη Ε.(ikasotaki@gmail.com) - Σμαραγδάκης Κ.(kesmarag@gmail.com)\end{small}
 \end{textblock}
}
...
\begin{itemize}
\item προβλήματα με κλάσματα (πολλαπλασιασμό κλασμάτων)
\end{itemize}

\section*{Παράδειγμα \hfill \small{}}
Ένα σχολείο έχει $225$ μαθητές. Απο αυτούς τα $\dfrac{3}{5}$ είναι κορίτσια. Να βρείτε πόσα κορίτσια και πόσα αγόρια έχει αυτό το σχολείο.\\
\textbf{Λύση}\\
Τα κορίτσια είναι το $\dfrac{3}{5}$ των μαθητών, άρα για να βρούμε τον αριθμό των κοριτσιών πολλαπλασιάζουμε το $\dfrac{3}{5}$ με το $225$ ο οποίος είναι ο συνολικός αριθμός των μαθητών του σχολείου. \\
Άρα, τα κορίτσια είναι $\dfrac{3}{5}\cdot 225 = \dfrac{3\cdot 225}{5}=\dfrac{675}{5}=135$.\\
Άρα, τα αγόρια είναι $225-135= 90$ (Δηλαδή για να βρούμε τον αριθμό/πλήθος των αγοριών: από τον αριθμό των μαθητών του σχολείου αφαιρούμε τον αριθμό των κοριτσιών).


\section*{Πρόβλημα 1 \hfill \small{}}
Ένα σχολείο έχει $425$ μαθητές. Απο αυτούς τα $\dfrac{3}{5}$ είναι αγόρια. Να βρείτε πόσα αγόρια και πόσα κορίτσια έχει αυτό το σχολείο.
 

\section*{Πρόβλημα 2 \hfill \small{}}
Ένα σχολείο έχει $333$ μαθητές. Απο αυτούς τα $\dfrac{5}{9}$ μαθαίνουν αγγλικά. Να βρείτε τον αριθμό των μαθητών αυτού του σχολείου που μαθαίνουν αγγλικά.


\section*{Πρόβλημα 3 \hfill \small{}}
Ένα σχολείο έχει $390$ μαθητές. Απο αυτούς τα $\dfrac{5}{6}$ μαθαίνουν αγγλικά.  Να βρείτε τον αριθμό των μαθητών αυτού του σχολείου που μαθαίνουν αγγλικά.
