...
\begin{textblock}{17}(-1,28)
 \color{backsite} \begin{small}Επιμέλεια: Κασωτάκη Ειρήνη (ikasotaki@gmail.com) - Σχολικό έτος 2021 - 2022\end{small}
 \end{textblock}
}
...
\huge \textbf{Τεστ}\\
\end{center} 
\textbf{Μαθηματικά Γ΄ Λυκείου} \hfill \textbf{Διάρκεια : \hspace{2em} 20 Λεπτά}
\subsection*{Ονοματεπώνυμο :\hfill Ημερομηνία : \hspace{5em}}
\end{shaded}
\vspace{2em}

%ΣΧΟΛΙΟ: Το τεστ αναφέρεται στο πεδίο ορισμού και στη γραφική παράσταση συνάρτησης.

\section*{Θέμα Α \hfill \small{50 μονάδες}}
Δίνεται η συνάρτηση:
$$ f(x)=\dfrac{2x+4}{x-2}  $$
\begin{enumerate}[i)]
 \item Να βρείτε το πεδίο ορισμού $Α$ της συνάρτησης $f(x)$
 \item Να βρείτε τις τιμές του $x\in \mathbb{R}$ για τις οποίες η γραφική παράσταση της $f$ 
       βρίσκεται πάνω από τον άξονα $x'x$.
\end{enumerate}


\section*{Θέμα B \hfill \small{50 μονάδες}}
Έστω οι συναρτήσεις $f(x)=x^3+3x^2+5x+1$ και $g(x)=x^3+2x^2+6x+3$. 
Να βρείτε τις τιμές του $x\in \mathbb{R}$ για τις οποίες η γραφική παράσταση της $f$ 
βρίσκεται πάνω από τηn γραφική παράσταση της $g$. 
