...
\section*{Θέμα  \hfill \small{100 μονάδες}}
Να λύσετε τις παρακάτω εξισώσεις:
\begin{enumerate}[i)]
\item $4x^{2}-19+6=0$ %παρόμοια με άσκηση 1(i) α' ομάδας σχολικού βιβλίου 
\item $2x^{2}-8x+8=0$ %παρόμοια με άσκηση 1(ii) α' ομάδας σχολικού βιβλίου 
\item $5x^{2}+x+3=0$ %παρόμοια με άσκηση 1(iii) α' ομάδας σχολικού βιβλίου 
\item $x^{2}-100=0$ %παρόμοια με άσκηση 2(i) α' ομάδας σχολικού βιβλίου 
\item $5x^{2}-x=0$ %παρόμοια με άσκηση 2(ii) α' ομάδας σχολικού βιβλίου 
\end{enumerate} 
