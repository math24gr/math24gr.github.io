...
Έστω βασικό σύνολο $Ω=\{ 2,4,6,\cdots ,18\}$ και σύνολα 
$$Α=\{ x\in Ω \quad| \quad x \text{ πολλαπλάσιο του } 4\}$$
$$Β=\{ x\in Ω \quad| \quad x \text{ πολλαπλάσιο του } 6\}$$
$$Γ=\{ x\in Ω \quad| \quad x \text{ πολλαπλάσιο του } 9\}$$
$$Δ=\{ 4,10,12,16,18 \}$$
Να γράψετε τα σύνολα:
\begin{enumerate}[i)]
 \item $Α\cup Β$
 \item $Α\cap Β$
 \item $Γ' \cap Δ$
