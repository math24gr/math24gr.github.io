...
\begin{enumerate}[i)]
\item $4x-2(3x-1)=7(x-6)-1$ %παρόμοια με άσκηση 1(iii) α' ομάδας σχολικού βιβλίου 
\item $12x-2(5-x)=-2(5-7x)$ %παρόμοια με άσκηση 2(ii) α' ομάδας σχολικού βιβλίου 
\end{enumerate} 
...
Να λύσετε τις παρακάτω εξισώσεις:
\begin{enumerate}[i)]
\item $\dfrac{x}{2}-\dfrac{x}{4}+\dfrac{49}{60}=\dfrac{x}{3}-\dfrac{x}{5}$ 
\item $\dfrac{3x-1}{3}-\dfrac{2x-1}{2}=\dfrac{2}{3}$ %παρόμοια με άσκηση 2(i) α' ομάδας σχολικού βιβλίου 
\end{enumerate}
