...
\end{center} 
\begin{center}
\textbf{Ερωτήσεις Κατανόησης της Θεωρίας για το Κεφάλαιο 4 "Εξισώσεις και Προβλήματα"} \hfill \textbf{}
\end{center}
%\subsection*{}
\end{shaded}
\vspace{2em}
%\section*{Θέμα 1 \hfill \small{25 μονάδες}}

%\section*{Θέμα 2 \hfill \small{25 μονάδες}}

%\section*{Θέμα 3 \hfill \small{25 μονάδες}}

%\section*{Θέμα 4 \hfill \small{25 μονάδες}}

\begin{enumerate}
\item Τι ονομάζουμε εξίσωση;
\item Τι ονομάζουμε λύση ή ρίζα μιας εξίσωσης;
\item Τι ονομάζουμε επίλυση μιας εξίσωσης;
\item Ποια εξίσωση ονομάζεται ταυτότητα;
\item Ποια εξίσωση ονομάζεται αόριστη;
\item Ποια εξίσωση ονομάζεται αδύνατη;
\end{enumerate}
