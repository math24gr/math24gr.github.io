...
\huge \textbf{Τεστ}\\
\end{center} 
\textbf{Μαθηματικά Α' Γυμνασίου} \hfill \textbf{Διάρκεια : \hspace{2em} 10 Λεπτά}
\subsection*{Ονοματεπώνυμο :\hfill Ημερομηνία : \hspace{5em}}
\end{shaded}
\vspace{2em}

\section*{Θέμα 1 \hfill \small{50 μονάδες}}
Πότε ένας αριθμός διαιρείται με το 10;
...
\hline                   
\textbf{Αριθμός} &\textbf{Διαιρείται με το 10} &\textbf{Δεν διαιρείται με το 10}\\
\hline 
  $1$       &                      &        \\
\hline 
  $5$       &                      &        \\
