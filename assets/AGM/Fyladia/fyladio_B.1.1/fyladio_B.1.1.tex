...
Δίνονται τα σημεία $Α,Β,Γ$. Να σχεδιάσετε τα ευθύγραμμα τμήματα
\begin{enumerate} [i)]
 \item $ΑΒ$
 \item $ΑΓ$
 \item $ΒΓ$
...
Δίνονται τα σημεία $Α$ και $Β$.
\begin{enumerate}[i)]
 \item Να σχεδιάσετε $3$ ευθείες που περνάνε από το $Α$.
 \item Να σχεδιάσετε μία ευθεία που περνάει συγχρόνως από τα σημεία $Α$ και $Β$.
\end{enumerate}



\section*{Άσκηση 3  \hfill \small{20 μονάδες}}
Δίνεται το σημείο $Α$. Να σχεδιάσετε δύο ημιευθείες που έχουν αρχή το σημείο Α.


\section*{Άσκηση 4  \hfill \small{} 10 μονάδες}
Να σχεδιάσετε δύο αντικείμενες ημιευθείες.
